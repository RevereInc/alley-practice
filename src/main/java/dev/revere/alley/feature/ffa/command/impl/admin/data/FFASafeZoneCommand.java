...
public class FFASafeZoneCommand extends BaseCommand {
    ...
    public void onCommand(CommandArgs command) {
        ...
        if (!spawnType.equalsIgnoreCase("pos1") && !spawnType.equalsIgnoreCase("pos2")) {
            player.sendMessage(this.getMessage(GlobalMessagesLocaleImpl.FFA_INVALID_SPAWN_TYPE));
            return;
        }
        ...
        player.sendMessage(this.getMessage(GlobalMessagesLocaleImpl.FFA_SAFE_ZONE_SET)
