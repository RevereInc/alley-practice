 ...
 * @since 01/09/2025
 */
@RewardTypeProvider(type = RewardType.TOURNAMENT_WIN)
public class TournamentRewardCalculatorImpl implements RewardCalculator {
    @Override
    public int calculateReward(Player player, Profile profile) {

        //TODO: Implement tournament reward logic
